...
async function play({ member, guild, channel }, query) {
  ...
  if (tracks.length === 1) {
    ...
    if (!player?.playing && !player?.paused && !player?.queue.tracks.length) {
      ...
      embed
        ...
        .setImage("https://cdn.discordapp.com/attachments/1098969636306960465/1139490611712491520/lucymusic.gif")  // Ganti dengan URL gambar atau GIF yang Anda inginkan
  ...
  embed.setImage("https://cdn.discordapp.com/attachments/1098969636306960465/1139490611712491520/lucymusic.gif");
